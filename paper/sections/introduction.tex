...
polysemantic, attribute through a basis that is not. We call the resulting
family \family{} (\emph{AND-gated Task-circuit Loss-Aligned Saliency}); its
first instantiation, \method{} (\family{} with a \textbf{T}ranscoder basis),
uses sparse TopK
...
\methodfree{} (\family{} with the model's \textbf{N}ative MLP-neuron basis),
recovers most of \method{}'s gain on GSM8K and surpasses it on

...
We do \emph{not} claim these systems results in this paper; they define the research arc if the dissociation
holds empirically.
...
Dimensions 2--3 are \emph{enabled by} feature dissociation plus mixed-precision structure; this
paper validates Dimension 1 (Spider exec accuracy at matched budget).

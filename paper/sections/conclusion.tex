...
in full precision. We showed that the right selection signal is a
\emph{conjunction}: protect a weight only if it is salient to the task loss
\emph{and} to the activation circuit separating clean from corrupted task
inputs.

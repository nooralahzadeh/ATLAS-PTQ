...
$\{0,1,2\}$, \method{} over $\{0,1\}$ (seed-2 in flight). All gaps are within
...
the Spider circuit-only result (\S\ref{sec:results-spider}): align-only tied \baseline{}

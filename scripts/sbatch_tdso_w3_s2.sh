...
#SBATCH --ntasks=1
#SBATCH --gres=gpu:4
#SBATCH --job-name=tdso_w3s2
#SBATCH --output=/capstor/scratch/cscs/fnoorala/ATLAS-PTQ/tacq_data/logs/tdso_w3_s2_%j.out
set -euo pipefail
...
SEED=2 WBITS=3 COMBINE=mult FORCE_RECOMPUTE=1 \
  TASKS="GSM8k MMLU_STEM MMLU_humanities MMLU_social_sciences" \
